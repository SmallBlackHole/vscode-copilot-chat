...
def analyze_evaluation_results():
    ...
    print(f"[SCORE] Average relevance score: {avg_score:.3f}/5")
    print(f"[THRESHOLD] All responses passed the threshold of {metrics.get('relevance.relevance_threshold', 0)}")
